...
function systemGen(domain: string, level: string) {
  ...
  return [
    ...
    "",
    "RULES:",
    "1. TEXT must be ONE single line with NO line breaks inside it, entirely in English,",
    "   grammatically correct and natural. TEXT must contain ZERO Arabic characters — not even",
    "   one Arabic word. Write the Arabic question and choices ONLY after their own Q:/A:/B:/C:",
    "   labels below, never inside or appended to the TEXT line itself.",
