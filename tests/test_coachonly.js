...
// فالعدد هنا اثنا عشر وعند إلياس أحد عشر، والفرق نفسه محروسٌ لا مصادفة.
ok(await m.evaluate(()=>document.querySelectorAll('.mode').length)===12,
  `اثنا عشر زرّاً لا أكثر — الأحد عشر المشتركة + إحصاء ١٠٢ الخاصّ بمحمد (${await m.evaluate(()=>document.querySelectorAll('.mode').length)})`);
...
ok(await e.evaluate(()=>document.querySelectorAll('.mode').length)===11,'أحد عشر زرّاً لا أكثر — بلا زرّ محمد');
