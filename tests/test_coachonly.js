...
ok(await m.evaluate(()=>document.querySelectorAll('.mode').length)===9,
  `تسعة أزرار لا أكثر — الثمانية المشتركة + إحصاء ١٠٢ الخاصّ به (${await m.evaluate(()=>document.querySelectorAll('.mode').length)})`);
...
ok(await e.evaluate(()=>document.querySelectorAll('.mode').length)===8,'ثمانية أزرار لا أكثر — بلا زرّ محمد');
