...
console.log('\n٢) ما ليس قراءةً: اختيارٌ له بوّابةٌ أقصر، وكتابةٌ بلا بوّابة');
...
// كانت القواعد والمفردات بلا بوّابة عمداً، وحُجّتها المكتوبة هنا أن للقواعد «بوّابة
// التصحيح الخاصة» — وهي بوّابةُ إعادة تعليمٍ بعد تكرار الخطأ (fixOn/itemStuck)، لا
// بوّابةَ تسرّعٍ قبل عرض الخيارات. فهما غرضان مختلفان يجتمعان ولا يتنازعان، ولم تكن
// الأولى تمنع نقراً أعمى أصلاً. وكذّبت البياناتُ الحيّة الحُجّة (هيا، ٢٢ أغسطس):
// القواعد ٠٫٩ث/٢٠٪ — التخمين من أربعة خيارات بالضبط. فوُصلت بوّابة التسرّع بهما
// (ENG_GATE) بمدًى أقصر من القراءة لأن الجملة ليست فقرة.
ok(others.g>=3&&others.g<=6,'وللقواعد بوّابةٌ قصيرة الآن — '+others.g+'ث (كانت صفراً)');
ok(others.v>=2&&others.v<=5,'وللمفردات كذلك — '+others.v+'ث');
ok(others.d===0,'والإملاء بلا بوّابة — كتابةٌ لا اختيارٌ من معروض');
