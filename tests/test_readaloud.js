...
(async()=>{
  ...
  console.log("\n§٢ سقف التسجيل مشتقٌّ من عدد الكلمات");
  {
    ...
    // ===== دعوى «القيمة = الكلمات × الوتيرة» رُوجعت ولم تُدهَس — ١٥ سبتمبر =====
    // كُتبت يوم كان السقف ضرباً مجرّداً، **وكذّبتها أوّل قراءةٍ حقيقية**: ١٦ كلمة بلغت
    // السقف بالضبط (٢٠١٨٣ ملّي لسقف ٢٠٠٠٠) فبُترت. والنموذج صار عتبةً ومعدّلاً، لأن
    // القياس يقول إن كلفة الكلمة تهبط بطول الجملة. وما جاءت له الدعوى باقٍ بحرفه:
    // **السقف يُشتقّ من الطول** — فيزيد بزيادته ولا يبقى ثابتاً.
    ok(r.long13>r.short&&r.long29>r.long13,
      `السقف يُشتقّ من الطول فعلاً: ٤⇒${r.short/1000}ث · ١٣⇒${r.long13/1000}ث · ٢٩⇒${r.long29/1000}ث`);
